    ...
    public class RedisFeaturesDemo
    {
        ...
        private static void Geo()
        {
            using (var client = RedisHelper.GetRedisClient())
            {
                ...
                client.AddGeoMembers(key, new RedisGeo(113.14, 23.08, "广州"), new RedisGeo(113.06, 23.02, "佛山"), new RedisGeo(114.22, 23.05, "惠州"), new RedisGeo(114.07, 22.33, "深圳"),
                    new RedisGeo(113.34, 22.17, "珠海"), new RedisGeo(117.17, 31.52, "合肥"), new RedisGeo(116.24, 39.55, "北京"), new RedisGeo(103.51, 36.04, "兰州"), new RedisGeo(106.42, 26.35, "贵阳"),
                    new RedisGeo(110.20, 20.02, "海口"), new RedisGeo(114.30, 38.02, "石家庄"), new RedisGeo(113.40, 34.46, "郑州"), new RedisGeo(126.36, 45.44, "哈尔滨"), new RedisGeo(114.17, 30.35, "武汉"),
                    new RedisGeo(112.59, 28.12, "长沙"), new RedisGeo(125.19, 43.54, "长春"), new RedisGeo(118.46, 32.03, "南京"), new RedisGeo(115.55, 28.40, "南昌"), new RedisGeo(123.25, 41.48, "沈阳"),
                    new RedisGeo(101.48, 36.38, "西宁"), new RedisGeo(117, 36.40, "济南"), new RedisGeo(112.33, 37.54, "太原"), new RedisGeo(108.57, 34.17, "西安"), new RedisGeo(121.29, 31.14, "上海"),
                    new RedisGeo(104.04, 30.40, "成都"), new RedisGeo(117.12, 39.02, "天津"), new RedisGeo(91.08, 29.39, "拉萨"), new RedisGeo(87.36, 43.35, "乌鲁木齐"), new RedisGeo(102.42, 25.04, "昆明"),
                    new RedisGeo(120.10, 30.16, "杭州"), new RedisGeo(106.33, 29.35, "重庆"));
